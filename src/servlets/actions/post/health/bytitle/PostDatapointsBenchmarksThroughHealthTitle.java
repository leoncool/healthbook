 ...
 * @author Leon
 */
public class PostDatapointsBenchmarksThroughHealthTitle extends HttpServlet {
	...
	public void processRequest(HttpServletRequest request,
		...
		try {
			...
			if (jdataImport.getData_points_single_list() != null
				...
				System.out
						.println("--------------dealing with single data point list--------");
				...
				String singleUnitID = datastream.getDatastreamUnitsList()
						.get(0).getShortUnitID();
				if (singleUnitID == null || singleUnitID.length() < 3) {
					singleUnitID = datastream.getDatastreamUnitsList().get(0)
							.getUnitID();
				}
				...
				System.out
						.println("--------------dealing with normal data point list--------");
			...
			if (jdataImport.getData_points() != null) {
				...
				totalInputSize = jdataImport.getData_points_single_list()
						.size();
			}

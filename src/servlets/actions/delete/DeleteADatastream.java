 ...
 * @author Leon
 */
public class DeleteADatastream extends HttpServlet {
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            {
            	 ReturnParser.outputErrorException(response, AllConstants.ErrorDictionary.Internal_Fault, null, streamID);
                 return;
            }
            Gson gson = new Gson();
